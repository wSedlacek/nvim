...
-- Check for AI chat command: opencode > claude > copilot-cli > copilot (fallback)
local default_ai_chat = "copilot"
if command_exists "opencode" then
  default_ai_chat = "opencode"
elseif command_exists "claude" then
  default_ai_chat = "claudecode"
elseif command_exists "copilot" then
  default_ai_chat = "copilot-cli"
end
